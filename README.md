...
```
bash <(curl -Ls https://raw.githubusercontent.com/vankhanh2001/3x-ui/main/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/vankhanh2001/3x-ui/main/install.sh) v2.1.1
```
